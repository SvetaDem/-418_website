#!C:\Users\Светлана\Desktop\learning\МДК\МДК 02.02 Инструментальные средства разработки ПО, У.С. Опалева\Programs\с418_website\с418_website\env\Scripts\python.exe
# -*- coding: utf-8 -*-
"""
